    ...
    <div className="pt-[10vh] pb-10 flex flex-col justify-center items-center w-[100%] md:h-[100vh]">
      {dataNow.length === 0 ? (
        ...
        <div>
          ...
          {dataNow.length !== 0 && (
            <div className={`mt-1 lg:mt-7 flex w-[500%]`}>
              {dataNow.map((item, index) => (
                <div
                  key={index}
                  className="w-full flex flex-col lg:flex-row items-center justify-center drop-shadow-lg"
                  style={{
                ...
                >
                  ...
                  />
                  <div className="w-[70%] md:w-[80%] lg:w-[420px] lg:h-[60vh] xl:w-[510px] p-3 bg-white">
                    <div>
